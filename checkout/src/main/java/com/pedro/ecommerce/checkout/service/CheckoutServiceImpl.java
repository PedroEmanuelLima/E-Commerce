...
import com.pedro.ecommerce.checkout.entity.CheckoutItemEntity;
import com.pedro.ecommerce.checkout.entity.ShippingEntity;
...
import com.pedro.ecommerce.checkout.util.UUIDUtil;
...
public class CheckoutServiceImpl implements CheckoutService {
    ...
    public Optional<CheckoutEntity> create(CheckoutRequest checkoutRequest) {
        ...
        checkoutCreatedEvent = CheckoutCreatedEvent.newBuilder()
